    ...
    <>
      <div className="flex flex-col md:flex-col lg:flex-row items-center lg:w-[110rem] relative mx-auto overflow-hidden ">
        <div className="lg:h-[50rem] lg:w-[50rem] h-auto w-auto py-20 px-5 gap-4 md:py-40 lg:mx-7">
          ...
          >
            Korem ipsum dolor sit amet, consectetur adipisicing elit, sed do se
            eiusmod temps incididunt ut labore et sa dolore si magna aliqua. Ut
            enim ad minim veniam, inant quis nostrud.
          </motion.p>
          <motion.p
            ref={ref}
            initial={{ y: 50, opacity: 0 }}
